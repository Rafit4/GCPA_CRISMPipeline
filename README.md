...
**Guía completa** (Git, Python, entorno, GUI y QGIS, con enlaces y versiones):  
[docs/02_instalacion.md](docs/02_instalacion.md)
...
Abrir la GUI: doble clic en `abrir_gui.bat`, o:
...
Manual de uso: [docs/08_manual_gui.md](docs/08_manual_gui.md)  
Instalación desde cero: [docs/02_instalacion.md](docs/02_instalacion.md)
...
| [docs/02_instalacion.md](docs/02_instalacion.md) | Guía de instalación (Git → GUI → QGIS) |
